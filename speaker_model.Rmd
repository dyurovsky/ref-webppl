...
empiricalImplicitVocabs <- all_data_dropped %>%
...
outcomes_implicit_jan<-webppl(program_file = "speaker.wppl", data=empiricalImplicitVocabs, data_var = "empiricalVocabs")

proc.time() - t1
# # 
# # ### clean up data from model
gamePredictions_luce2 <- outcomes_implicit_jan %>%
