...
prop_methods_exposures %>% 
  ...
  geom_line(aes(x=(exposureRate), y=mean, group=interaction(method,condition), color=method),  size=.9, position=position_dodge(.25)) +
...
model_fit %>%
  rename(mean_pred_plot=mean_pred_partner,
         se_pred_plot=se_pred_partner) %>%
...
ggplot(plot_data, aes(x = log(freq), y = prop, 
  ...
  labs(y="Proportion of References\nusing Gesture + Speech", x='Referent Frequency (logged)') +
  coord_cartesian(ylim=c(0,.4)) +
  # facet_grid(.~age) +
  theme_bw()+
  scale_fill_manual(values=c("#87d868", "#54a832", "#2c6d12", "#000000"), name='Age of their Child', labels=c('14 months', '18 months','22 months','26 months')) +
  scale_color_manual(values=c("#87d868", "#54a832", "#2c6d12", "#000000"), name='Age of their Child', labels=c('14 months', '18 months','22 months','26 months')) 
