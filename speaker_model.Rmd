...
full_explicit <- read_csv("empirical_data/1.30.2019_explicit_model.csv")

all_data_dropped <- full_explicit %>% filter(toBeDropped==0)
...
t1 <- proc.time()
outcomes<-webppl(program_file = "speaker_clean.wppl", data=empiricalExplicitVocabs, data_var = "empiricalVocabs")



gamePredictions_1.30 <-outcomes %>%
