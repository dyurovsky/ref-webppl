...
cross_props_2_24 <- map_df(seq(.25,.75,.25), ~crossit_probs(.x, 2, 24))
cross_props_4_24 <- map_df(seq(.25,.75,.25), ~crossit_probs(.x, 4, 24))
cross_props_6_24 <- map_df(seq(.25,.75,.25), ~crossit_probs(.x, 6, 24))

cross_props <- bind_cols(cross_props_2_16, cross_props_6_16) %>%
  mutate(type="xsit")
